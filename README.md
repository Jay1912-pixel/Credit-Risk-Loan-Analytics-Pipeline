...
The dataset can be obtained from the original public source on Kaggle:
...
<p align="center">
  <img src="screenshots/executive_portfolio_overview.png" alt="Executive Portfolio Overview Dashboard" width="1000">
</p>
...
* Loan Term and Issue Date filters
...
<p align="center">
  <img src="screenshots/risk_default_deep_dive.png" alt="Risk and Default Deep Dive Dashboard" width="1000">
</p>

The second dashboard provides deeper analysis of borrower risk and default behavior, including:
...
* Credit Grade and Risk Category filters
...
This feature enables the portfolio to be analyzed across different borrower risk segments.
...
Measures the total monetary value of loans classified as:
...
* Which risk categories contain the most risky borrowers?
...
> The raw Lending Club CSV dataset is not included in the repository due to its large file size.
...
Place the CSV file in the appropriate local data directory.
...
Configure the database connection details in the Python ETL script.
...
| Dashboard                    | Focus                                                                   |
| ---------------------------- | ----------------------------------------------------------------------- |
| Executive Portfolio Overview | Portfolio KPIs, funding trends, loan status, risk distribution          |
...
**GitHub:** [Jay1912-pixel](https://github.com/Jay1912-pixel)

**LinkedIn:** [Jay Kumar Patel](https://www.linkedin.com/in/jay-kumar-patel-597587292/)
